...
Birthday bigger: <input type="text" value="" name="birthDateBigger" placeholder="DD.MM.YYYY" autocomplete="off">
less <input type="text" value="" name="birthDateLess" placeholder="DD.MM.YYYY" autocomplete="off"> <br />
Gender:
